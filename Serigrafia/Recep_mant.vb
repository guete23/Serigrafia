...
Public Class Recep_mant
    ...
    Friend WithEvents recepcion As System.Windows.Forms.Label
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(Recep_mant))
        ...
        Me.GroupBox1.Controls.Add(Me.recepcion)
        ...
        'recepcion
        '
        Me.recepcion.BackColor = System.Drawing.Color.White
        Me.recepcion.Font = New System.Drawing.Font("Courier New", 9.75!)
        Me.recepcion.Location = New System.Drawing.Point(186, 23)
        Me.recepcion.Name = "recepcion"
        Me.recepcion.Size = New System.Drawing.Size(175, 24)
        Me.recepcion.TabIndex = 103
        Me.recepcion.Text = " "
        Me.recepcion.TextAlign = System.Drawing.ContentAlignment.MiddleLeft
        '
        'Label3
        '
        ...
        Me.Text = "Anulación de Recepciones"
...
#End Region
    ...
    Private Sub llena_grid()
        ...
        strsql = "SELECT * , (SELECT SUM(PRIMERAS + SEGUNDAS) FROM SERI24 WHERE SERI23.PROYECTO = SERI24.PROYECTO) AS DESPACHO  FROM SERI23 LEFT JOIN SERI20 ON SERI23.PROYECTO = SERI20.PROYECTO JOIN SERI15 ON SERI20.NIT = SERI15.NIT WHERE SERI23.ESTADO = 'A'"
    ...
    Private Sub actualiza_proyecto()
        ...
        Try
            strsql = "UPDATE SERI23 SET ESTADO  = 'X' , UNIDADES = 0 WHERE RECEP = " & CInt(recepcion.Text)
            comando.CommandText = strsql
            afectados = comando.ExecuteNonQuery()

            strsql = "INSERT INTO SERI25 (PROCESO,DOCTO,FECHA,MOTIVO,USUARIO) VALUES ('R','" & recepcion.Text & "','" & Now & "','" & motivo.Text & "','" & usuario & "')"
            comando.CommandText = strsql
            afectados = comando.ExecuteNonQuery()
    ...
    Private Sub llena_datos()
        ...
        Try
            recepcion.Text = Format(fg(f, 1), "00000000")
