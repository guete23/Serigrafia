...
#End Region
    ...
    Private Sub llena_fg()
        ...
        Dim i As Integer = 1
        Dim strSQL As String = "select * FROM SERI24 LEFT JOIN SERI20 ON SERI24.PROYECTO = SERI20.PROYECTO WHERE FECHA_D BETWEEN  '" & fecha & "' AND '" & fecha1 & "' AND NIT IN ('JT','ZUNTEX') "
