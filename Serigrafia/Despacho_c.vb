...
Public Class Despacho_c
    ...
    Dim l As Integer = 1
    Dim op As String = "DESPACHO|SERI24.PROYECTO|NOMBRE|SERI231.FECHA"
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(Despacho_c))
        ...
        Me.criterio.Items.AddRange(New Object() {"DESPACHO", "PROYECTO", "CLIENTE", "FECHA "})
...
#End Region
    ...
    Private Sub setea_grid()
        fg.Rows.Count = 1
        fg.Rows(0).Height = 35
        fg.Cols(10).DataType = GetType(Image)
    End Sub
    ...
    Private Sub criterio_SelectedIndexChanged(sender As System.Object, e As System.EventArgs) Handles criterio.SelectedIndexChanged
        ...
        Select Case criterio.SelectedIndex
            Case 0
                strsql = "SELECT DISTINCT DESPACHO FROM SERI24 ORDER BY DESPACHO DESC "
            Case 1
                strsql = "SELECT DISTINCT PROYECTO FROM SERI24 ORDER BY PROYECTO  DESC"
            Case 2
            ...
            Case 3
                strsql = "SELECT DISTINCT CONVERT(VARCHAR(7), FECHA_D, 120) AS FECHA FROM SERI24 ORDER BY FECHA DESC "
        End Select
    ...
    Private Sub procesa()
        ...
        If criterio.SelectedIndex = 3 Then
            busca = "YEAR(FECHA_D) = '" & Mid(nombre.Text, 1, 4) & "' AND MONTH(FECHA_D) = '" & Mid(nombre.Text, 6) & "'"
        End If
        strsql = "SELECT * FROM SERI24 LEFT JOIN SERI20 ON SERI24.PROYECTO = SERI20.PROYECTO LEFT JOIN SERI15 ON SERI15.NIT = SERI20.NIT WHERE " & busca
        llena_grid()
    End Sub
