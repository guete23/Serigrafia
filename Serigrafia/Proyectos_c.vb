Public Class Proyectos_c

    Dim cnn As New SqlClient.SqlConnection
    Dim h As String = "###,###,##0.00"
    Private Sub Proyectos_c_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        llena_combos(proyecto, "SELECT PROYECTO FROM SERI20 ORDER BY PROYECTO DESC", "PROYECTO")
    End Sub

    Private Sub proyecto_SelectedIndexChanged(sender As System.Object, e As System.EventArgs) Handles proyecto.SelectedIndexChanged
    ...
    Private Sub Proyecto_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles proyecto.KeyPress
        AutoCompletar(proyecto, e)
    End Sub
