...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(Proy_mant))
        ...
        Me.fg.Size = New System.Drawing.Size(1181, 473)
        ...
        Me.GroupBox1.Size = New System.Drawing.Size(1165, 210)
        ...
        Me.motivo.Location = New System.Drawing.Point(186, 151)
        ...
        Me.unidades.Location = New System.Drawing.Point(186, 121)
        ...
        Me.cliente.Location = New System.Drawing.Point(186, 91)
        ...
        Me.descripcion.Location = New System.Drawing.Point(186, 61)
        ...
        Me.proyecto.Location = New System.Drawing.Point(186, 23)
        Me.proyecto.Name = "proyecto"
        Me.proyecto.Size = New System.Drawing.Size(175, 24)
        Me.proyecto.TabIndex = 103
        Me.proyecto.Text = " "
        ...
        Me.Text = "Anulación de Proyectos"
...
#End Region
    ...
    Private Sub llena_grid()
        ...
        For Each dr In dt.Rows
            ...
            Catch ex As Exception
            End Try
            If (rec = 0) And (des = 0) Then
                l = fg.Rows.Count
                fg.Rows.Count = l + 1
                fg(l, 1) = dr("PROYECTO")
                fg(l, 2) = dr("DESCRIPCION_P")
                fg(l, 3) = dr("NOMBRE")
                fg(l, 4) = dr("UNIDADES")
            End If
        Next dr
    ...
    Private Sub actualiza_proyecto()
        ...
        Try
            strsql = "UPDATE SERI20 SET ESTADO  = 'X' WHERE PROYECTO = " & CInt(proyecto.Text)
            comando.CommandText = strsql
            afectados = comando.ExecuteNonQuery()

            strsql = "INSERT INTO SERI25 (PROCESO,DOCTO,FECHA,MOTIVO,USUARIO) VALUES ('P','" & proyecto.Text & "','" & Now & "','" & motivo.text & "','" & usuario & "')"
            comando.CommandText = strsql
            afectados = comando.ExecuteNonQuery()
    ...
    Private Sub llena_datos()
        ...
        Try
            proyecto.Text = Format(fg(f, 1), "00000000")
            descripcion.Text = fg(f, 2)
            cliente.Text = fg(f, 3)
            unidades.Text = Format(fg(f, 4), "#####0")
            motivo.Text = ""
        Catch
        End Try
    End Sub
